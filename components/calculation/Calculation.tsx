...
export const Calculation = () => {
  ...
  return <div>
    <div>
      <h4>Личные данные</h4>
      <div>
      <Input  label={'Ваш текущий возраст'} setValue={setCurrentAge} value={currentAge}/>
        <Input  label={'Предполагаемый возраст дожития'} setValue={setDeathAge} value={deathAge}/>
      </div>

      <h4>Данные о зарплате</h4>
      <div>
        <Input  label={'Ваша текущая зарплата'} setValue={setSalary} value={salary}/>
        <Input  label={'Районный кофициент (в процентах)'} setValue={setRegionBonus} value={regionBonus}/>
      </div>

      <h4>Данные о тратах</h4>
      <div>
        <Input  label={'Стоимость аренды'} setValue={setMoneyRent} value={moneyRent}/>
        <Input  label={'Комунальные платежи'} setValue={setMoneyFlat} value={moneyFlat}/>
        <Input  label={'Траты на еду'} setValue={setMoneyEat} value={moneyEat}/>
        <Input  label={'Траты на развлечения'} setValue={setMoneyFun} value={moneyFun}/>
        <Input  label={'Траты на здоровье'} setValue={setMoneyHealth} value={moneyHealth}/>
      </div>
